...
/* _BAL_UNKNOWN_GEOMETRY_
 *   no geometry
 * _BAL_HOMOTHETY_GEOMETRY_
 *   only scale factors for the voxel sizes
 * _BAL_TRANSLATION_GEOMETRY_
 *   scale factors + translation
 * _BAL_QFORM_GEOMETRY_
 *   4x3 matrix
 */
typedef enum bal_imageGeometry {
  _BAL_UNKNOWN_GEOMETRY_,
  _BAL_HOMOTHETY_GEOMETRY_,
  _BAL_TRANSLATION_GEOMETRY_,
  _BAL_QFORM_GEOMETRY_
